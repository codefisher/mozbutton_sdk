...
config = {
    ...
    "applications_data": {
        "browser":   (
                      #("Firefox", "{ec8030f7-c20a-464f-9b0e-13a3a9e97384}", "42.0", "58.0"),
                      ("Pale Moon", "{8de7fcbb-c55c-4fbe-bfc5-fc555c87dbc4}", "20.0", "40.*"),
                      ),
        "messenger": (
                      ("Thunderbird", "{3550f703-e582-4d05-9a08-453d09bdfdc6}","20.0", "65.0"),
        ...
        #              ),
        "suite": (
                      ("SeaMonkey", "{92650c4d-4b8e-4d2a-b7eb-24ecf4f6b63a}", "2.20", "2.39"),
                      ),
    },
    "files_to_overlay": {
